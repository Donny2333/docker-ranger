	  ...
	  <a href="#" id="options" data-type="tagchecklist" data-pk="1" data-url="/post" data-title="Select options"></a>
	      ...
	      $.extend(TagChecklist.prototype, {
	          renderList: function() {
	              ...
	              var $tbody = $('<tbody><tr><th><input type="checkbox" data-id="selectAllComponent" /> 组件</th><td><strong>Permissions</strong></td></tr></tbody>');
